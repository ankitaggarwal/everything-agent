...
_TOOL_HINT = (
    ...
    "never say you can't, never list the moves, and trust that the dance worked. If they "
    "ask for the 'zoo' dance, call dance(move='zoo'). When they say stop / that's enough / "
    "quiet, call stop(). Use "
